# FormFusion - Basic useForm usage

This repository contains a simple example of using the useForm hook from the FormFusion [library](https://www.corelabui.com/)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/corelabui/basic-useform-usage.git
   ```

2. Install dependencies:

   ```bash
   cd basic-useform-usage
   npm install
   ```
